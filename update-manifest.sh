...
echo "1. Replace 'kernastra' with your actual GitHub username (if needed)"
...
echo "https://github.com/kernastra/TMDBintros/releases/download/v${VERSION}/TMDBintros.dll"
echo ""
